export const languageEnglish = {
    ...
    pluginPermissionConsent: {
        ...
        inlayWrite: "Create, read, and delete the plugin's own Inlays",
        inlayRead: "Read foreign or legacy Inlays",
        inlayManage: "Delete foreign Inlays or detach references",
    ...
    pluginSecretConsent: {
        storeTitle: "Store write-only Secret",
        replaceTitle: "Replace write-only Secret",
        store: "Store",
        replace: "Replace",
        cancel: "Cancel",
        allowedOrigins: "Allowed origins",
        allowedPlacements: "Allowed placements",
        writeOnlyNotice: "The plugin cannot read the stored value back.",
    },
