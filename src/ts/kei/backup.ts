...
import { replaceAndPersistDatabaseWithPluginRuntime, requiresFullEncoderReload } from "../globalApi.svelte"
        ...
        while(true){
            ...
            if(selected === "Cancel"){
                ...
                if(backup){
                    ...
                    if(res.status === 200){
                        await replaceAndPersistDatabaseWithPluginRuntime(await res.json())
